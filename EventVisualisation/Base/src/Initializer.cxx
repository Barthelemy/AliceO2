...
/// \brief   Implementation of Initializer class.
...
void Initializer::SetupGeometry()
{
  ...
  auto geoManager = GeometryManager::Instance();
  TEveGeoShape *shape = nullptr;
...
void Initializer::SetupBackground()
{
  ...
  for(int viewIter=0;viewIter<MultiView::NumberOfViews;++viewIter){
    TEveViewer *view = MultiView::Instance()->GetView(static_cast<MultiView::EViews>(viewIter));
